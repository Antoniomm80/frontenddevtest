...
import {ProductDetailPage} from "./components/productDetailsPage/productDetailPage.jsx";
...
export const UseCasesContext = createContext({findProductsUseCase, findByIdUseCase, getCartCountUseCase, addToCartUseCase});
...
function App() {
    ...
    return (
        <QueryClientProvider client={queryClient}>
            <UseCasesContext.Provider value={{findProductsUseCase, findByIdUseCase, getCartCountUseCase, addToCartUseCase}}>
